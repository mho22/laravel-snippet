...
test.describe('injectSnippetPreloads', () => {
    ...
    test('inserts both preload tags before </head> when a snippet placeholder is present', () => {
        ...
        expect(out).toContain('rel="preload" as="fetch" href="/laravel-snippet/laravel.zip"');
        expect(out).toContain('rel="preload" as="worker" href="/laravel-snippet/snippet-worker/index.js"');
